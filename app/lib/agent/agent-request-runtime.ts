    ...
    async start(controller) {
      ...
      try {
        ...
        const preparation = await prepareAgentRequestExecution({
          ...
          recoveryBaseRecord = preparationRuntimeState.recoveryBaseRecord;
          selectedSkill = preparationRuntimeState.selectedSkill;
          skillSource = preparationRuntimeState.skillSource;
          // A rejected content change must retain the original recovery lock.
          skillContentHash = recoveryBaseRecord?.skillContentHash || preparationRuntimeState.skillContentHash;
          throw error;
        });
