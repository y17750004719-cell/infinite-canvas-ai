...
- **稳定共性:** use as non-negotiable must-haves: vertical 2:3 paper canvas, small cluster, scanned-paper view, old print defects, serif/typewriter text, and a saturated color anchor visible at thumbnail size.
...
1. **Canvas:** What is the output frame and base surface?
   - tall vertical 2:3 phone-poster; full-frame aged paper; no border, no mockup.
...
- "用 $gc-minimal-zine-poster-v0-1 做一张关于雨天的图"
- "用 $gc-minimal-zine-poster-v0-1 标准模式，做一张关于旧书的图"
- "用这张照片做一张同风格 poster"
